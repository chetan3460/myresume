...
var horizontalMovement = $(".h-movement");
var parallaxUp = $(".parallax-block-wrap");
var SkillsRow = $(".skills--block");
var lazy = $(".lazy-image,.lazy-video");
...
var Animation = /*#__PURE__*/_createClass(function Animation() {
  ...
  _defineProperty(this, "bindEvents", function () {
    ...
    _this.fadeUpStagger();
    _this.title_animation();
    _this.textRevealAnimation();
    _this.textGradientAnimation();
    ...
    var onWindowFullyLoaded = function onWindowFullyLoaded() {
  ...
  // fade In
  _defineProperty(this, "fadeInAnimation", function () {
    var fadeIn = document.querySelectorAll(".fade-in");
    if (fadeIn.length) {
      fadeIn.forEach(function (container) {
        var fadeInTimeline = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].timeline({
          scrollTrigger: {
            trigger: container,
            start: "50px bottom"
          }
        });
        var delay = container.getAttribute("data-delay");
  ...
  // fade Up Stagger
  _defineProperty(this, "fadeUpStagger", function () {
    var fadeUpWrapper = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].utils.toArray(".fade-up-stagger-wrap");
    if (fadeUpWrapper.length) {
      fadeUpWrapper.forEach(function (fadeUpWrap) {
        var fadeUp = fadeUpWrap.querySelectorAll(".fade-up-stagger");
        var delay = fadeUpWrap.getAttribute("data-delay");
        gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(fadeUp, {
          scrollTrigger: {
            trigger: fadeUpWrap,
            start: "5% 100%"
          },
  ...
  // Animation gsap 
  _defineProperty(this, "title_animation", function () {
    // Animation gsap 
    function title_animation() {
      ...
      var quotes = document.querySelectorAll(".sec-title-animation .title-animation");
      quotes.forEach(function (quote) {
        ...
        quote.split = new split_type__WEBPACK_IMPORTED_MODULE_0__["default"](quote, {
          type: "lines,words,chars",
          linesClass: "split-line"
        });
        gsap__WEBPACK_IMPORTED_MODULE_2__["default"].set(quote, {
          perspective: 400
        });
        if (animation[1] == "style1") {
          gsap__WEBPACK_IMPORTED_MODULE_2__["default"].set(quote.split.chars, {
            opacity: 0,
            y: "90%",
            rotateX: "-40deg"
          });
        ...
        quote.animation = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(quote.split.chars, {
          scrollTrigger: {
            trigger: quote,
            start: "top 90%"
          },
          ...
          opacity: 1,
          duration: 1,
          ease: gsap__WEBPACK_IMPORTED_MODULE_4__.Back.easeOut,
          stagger: .02
        });
      });
    }
    ...
    title_animation();
    var typeSplit = new split_type__WEBPACK_IMPORTED_MODULE_0__["default"]("[text-split]", {
      types: "words, chars",
      tagName: "span"
    });
    ...
    gsap__WEBPACK_IMPORTED_MODULE_2__["default"].set("[text-split]", {
      opacity: 1
    });
  });
  _defineProperty(this, "textRevealAnimation", function () {
    var splitTypes = document.querySelectorAll('.reveal-type');
    splitTypes.forEach(function (_char, i) {
      var text = new split_type__WEBPACK_IMPORTED_MODULE_0__["default"](_char, {
        types: ['chars', 'words']
      });
      gsap__WEBPACK_IMPORTED_MODULE_2__["default"].from(text.chars, {
        scrollTrigger: {
          trigger: _char,
          start: 'top 80%',
          end: 'top 20%',
  ...
  _defineProperty(this, "textGradientAnimation", function () {
    if (innerWidth > 576) {
      var folksBD = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].timeline({
        repeat: -1,
        delay: 0.5,
        scrollTrigger: {
          trigger: '.folks-text',
      ...
      gsap__WEBPACK_IMPORTED_MODULE_2__["default"].set('.folks-text', {
        opacity: 0
      });
      gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to('.folks-text', {
        opacity: 1,
        duration: 1,
        ease: 'power2.out',
        scrollTrigger: {
      ...
      var mySplitText = new split_type__WEBPACK_IMPORTED_MODULE_0__["default"](".folks-text", {
        type: "words,chars,capitalize"
      });
      var chars = mySplitText.chars;

      // Define the start and end colors for the gradient
      var startColor = (0,tinycolor2__WEBPACK_IMPORTED_MODULE_1__["default"])("#14CF93");
      var endColor = (0,tinycolor2__WEBPACK_IMPORTED_MODULE_1__["default"])("#F8EC3A");
      folksBD.to(chars, {
        duration: 0.5,
        scaleY: 0.6,
        ease: "power3.out",
      ...
      folksBD.to(chars, {
        color: function color(i, el, arr) {
          ...
          return tinycolor2__WEBPACK_IMPORTED_MODULE_1__["default"].mix(startColor, endColor, i / arr.length * 100).toString();
        },
        ease: "power2.out",
        stagger: 0.03,
        duration: 0.3
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ DynamicImports)
/* harmony export */ });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils */ "./src/js/utils.js");
/* harmony import */ var _componentList__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../componentList */ "./src/js/componentList.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var DynamicImports = /*#__PURE__*/_createClass(function DynamicImports() {
  var _this = this;
  _classCallCheck(this, DynamicImports);
  _defineProperty(this, "init", function () {
    _this.setDomMap();
    _this.bindEvents();
    _this.components();
  ...
  _defineProperty(this, "bindEvents", function () {
    // Window Events
    _this.window.scroll(_this.windowScroll);
  });
  _defineProperty(this, "windowScroll", function () {
    _this.components();
  });
  _defineProperty(this, "components", function () {
    if (_componentList__WEBPACK_IMPORTED_MODULE_1__.componentList) {
      $.each(_componentList__WEBPACK_IMPORTED_MODULE_1__.componentList, function (_, _ref) {
        var el = _ref.element,
          classID = _ref.className,
          mobile = _ref.mobile;
        if (!mobile && _utils__WEBPACK_IMPORTED_MODULE_0__.max1200.matches) return;
        (0,_utils__WEBPACK_IMPORTED_MODULE_0__.importComponent)(el, classID);
      });
    }
  });
  this.init();
...
var Header = /*#__PURE__*/_createClass(function Header(_ref) {
  ...
  _defineProperty(this, "bindEvents", function () {
    ...
    var lastScrollTop = 0;
    var handleHeader = {
      toggleHide: function toggleHide(scrollPos) {
      ...
      addBG: function addBG(scrollPos) {
        if (scrollPos > header.height()) header.addClass("on-scroll");else header.removeClass("on-scroll");
      },
    ...
    function scrollHeaderSwitch() {
      if (_utils__WEBPACK_IMPORTED_MODULE_0__.viewport.width > 767) {
        _utils__WEBPACK_IMPORTED_MODULE_0__["default"].on('scroll', function (inst) {
          var scrollPos = inst.scroll;
          handleHeader.addBG(inst.scroll);
          handleHeader.toggleHide(inst.scroll);
        });
      } else {
        var lastPos = $('.wrapper').scrollTop();
...
/* harmony export */   max1200: () => (/* binding */ max1200),
/* harmony export */   max375: () => (/* binding */ max375),
/* harmony export */   max767: () => (/* binding */ max767),
/* harmony export */   min1024: () => (/* binding */ min1024),
/* harmony export */   min991: () => (/* binding */ min991),
/* harmony export */   pointerCurr: () => (/* binding */ pointerCurr),
/* harmony export */   useRem: () => (/* binding */ useRem),
/* harmony export */   viewport: () => (/* binding */ viewport),
/* harmony export */   viewportBreak: () => (/* binding */ viewportBreak),
/* harmony export */   xGetter: () => (/* binding */ xGetter),
/* harmony export */   xSetter: () => (/* binding */ xSetter),
/* harmony export */   yGetter: () => (/* binding */ yGetter),
/* harmony export */   ySetter: () => (/* binding */ ySetter)
/* harmony export */ });
/* harmony import */ var lenis__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lenis */ "./node_modules/lenis/dist/lenis.mjs");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");

var importComponent = function importComponent(element, classID) {
  // if (element.length && !element.hasClass("init") && inVP(element)) { // for lazy loading
  if (element.length && !element.hasClass("init")) {
    __webpack_require__("./src/js/components lazy recursive ^\\.\\/.*$")("./".concat(classID)).then(function (module) {
      new module["default"]();
    });
...
var min991 = window.matchMedia("(min-width: 991px)");
var max1200 = window.matchMedia("(max-width: 1200px)");
var max767 = window.matchMedia("(max-width: 767px)");
var max375 = window.matchMedia("(max-width: 375px)");
var lerp = function lerp(a, b) {
  var t = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0.08;
  return a + (b - a) * t;
};
var xSetter = function xSetter(el) {
  return gsap.quickSetter(el, 'x', "px");
};
var ySetter = function ySetter(el) {
  return gsap.quickSetter(el, 'y', "px");
};
var xGetter = function xGetter(el) {
  return gsap.getProperty(el, 'x');
};
var yGetter = function yGetter(el) {
...
var pointerCurr = function pointerCurr() {
  return pointer;
};
...
var useRem = function useRem(vw, maxWidth) {
  vw = viewport.width < maxWidth ? vw * viewport.width / 1000 : vw / 10;
  return function (value) {
    return Number((value * vw).toFixed(2));
  };
};
...
var viewportBreak = function viewportBreak(options) {
  var md = options.md,
    sm = options.sm,
    xs = options.xs;
  var result;
...
var map = {
	...
	"./BannerBlock": [
		"./src/js/components/BannerBlock.js",
		"BannerBlock"
	],
	"./BannerBlock.js": [
		"./src/js/components/BannerBlock.js",
	...
	"./HorizontalMovement": [
		"./src/js/components/HorizontalMovement.js",
		"HorizontalMovement"
	],
	"./HorizontalMovement.js": [
		"./src/js/components/HorizontalMovement.js",
		"HorizontalMovement"
	],
	"./LazyLoad": [
	...
	"./ParallaxUp": [
		"./src/js/components/ParallaxUp.js",
		"ParallaxUp"
	],
	"./ParallaxUp.js": [
		"./src/js/components/ParallaxUp.js",
	...
	"./SkillsRow": [
		"./src/js/components/SkillsRow.js",
		"SkillsRow"
	],
	"./SkillsRow.js": [
		"./src/js/components/SkillsRow.js",
...
/* harmony import */ var _components_DynamicImports__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/DynamicImports */ "./src/js/components/DynamicImports.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new ( /*#__PURE__*/_createClass(function App() {
  var _this = this;
  ...
  _defineProperty(this, "initComponents", function () {
    ...
    new _components_Animation__WEBPACK_IMPORTED_MODULE_2__["default"]();
    new _components_DynamicImports__WEBPACK_IMPORTED_MODULE_1__["default"]();
    window.lenis = _utils__WEBPACK_IMPORTED_MODULE_3__["default"];
  });
  _defineProperty(this, "setDomMap", function () {
    _this.window = $(window);
  ...
  _defineProperty(this, "bindEvents", function () {
    ...
    function handleFooterCursor() {
      var footerCursorWrap = '.footer__cursor';
      var footerCursor = '.footer__cursor-main';
      function mousMove() {
        if ($(footerCursor).length) {
          var iconsX = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.xGetter)(footerCursor);
          var iconsY = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.yGetter)(footerCursor);
          (0,_utils__WEBPACK_IMPORTED_MODULE_3__.xSetter)(footerCursor)((0,_utils__WEBPACK_IMPORTED_MODULE_3__.lerp)(iconsX, (0,_utils__WEBPACK_IMPORTED_MODULE_3__.pointerCurr)().x), 0.01);
          (0,_utils__WEBPACK_IMPORTED_MODULE_3__.ySetter)(footerCursor)((0,_utils__WEBPACK_IMPORTED_MODULE_3__.lerp)(iconsY, (0,_utils__WEBPACK_IMPORTED_MODULE_3__.pointerCurr)().y - $(footerCursorWrap).get(0).getBoundingClientRect().top), 0.01);
        }
    ...
    _this.gotoTop.on('click', function () {
      _utils__WEBPACK_IMPORTED_MODULE_3__["default"].scrollTo(0, {
        duration: 1.5
    ...
    $(document).ready(function () {
      ...
      $(".scrollToSection").click(function (e) {
        ...
        if (window.innerWidth <= 991) {
          ...
          _utils__WEBPACK_IMPORTED_MODULE_3__["default"].start(); // Start Lenis scrolling on mobile
        }
        ...
        _utils__WEBPACK_IMPORTED_MODULE_3__["default"].scrollTo(targetElement, {
          offset: -headerHeight - 5,
          // Adjust for header height
          duration: 1.5,
          // Scroll duration (in seconds)
          onComplete: function onComplete() {
            // Callback function when scroll is complete
            console.log("Scrolled to ".concat(targetSectionId));
          }
        });
        console.log("Scroll initiated to ".concat(targetSectionId));
      });

      // IntersectionObserver to handle adding 'active' class on scroll
      var sections = document.querySelectorAll("section"); // Assuming your sections are wrapped in <section> tags
      var navLinks = document.querySelectorAll(".scrollToSection");

      // Observer Options: Different rootMargin for mobile to handle smaller screens
      var observerOptionsMobile = {
        root: null,
        rootMargin: "-20% 0px -60% 0px",
        // Adjusted margins for mobile to ensure early detection
        threshold: 0.1 // Trigger when 10% of the section is visible on mobile
      };

      // Observer Options: Keep original for desktop
      var observerOptionsDesktop = {
        root: null,
        rootMargin: "-50% 0px",
        // When 50% of the section is in the viewport
      ...
      var sectionObserver = new IntersectionObserver(function (entries) {
        entries.forEach(function (entry) {
          var targetSectionId = "#".concat(entry.target.id);
          var activeLink = document.querySelector(".scrollToSection[href='".concat(targetSectionId, "']"));
    ...
    // Slowed Pin Section
    gsap.utils.toArray('.slowed-pin').forEach(function (slowedPin) {
      var slowedText = slowedPin.querySelector('.slowed-text');
      var slowedTextWrapper = slowedPin.querySelector('.slowed-text-wrapper');
      var slowedImagesWrapper = slowedPin.querySelector('.slowed-images');
      var slowedImages = slowedPin.querySelectorAll('.slowed-image img');
      gsap.to(slowedText, {
        scrollTrigger: {
          trigger: slowedText,
          scrub: true,
          ...
          start: "top top",
            ...
            var durationHeight = slowedImagesWrapper.offsetHeight - window.innerHeight;
      ...
      slowedImages.forEach(function (sImage) {
        gsap.to(sImage, {
          scrollTrigger: {
            trigger: sImage,
            scrub: true,
    ...
    $('[data-popup="contact"]').on('click', function (e) {
      ...
      _utils__WEBPACK_IMPORTED_MODULE_3__["default"].stop();
    });
  });
  _defineProperty(this, "windowResize", function () {
    _this.screenWidth = _this.window.width();
    _this.screenHeight = _this.window.height();
  ...
  _defineProperty(this, "windowScroll", function () {
    ...
    _this.header.toggleClass('top', topOffset > 10);
    _this.header.toggleClass('sticky', topOffset > 600);
    if (topOffset > _this.previousScroll || topOffset < 500) {
...
/******/ })()
;
//# sourceMappingURL=app-2.5.min.js.map